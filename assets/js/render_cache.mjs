...
// merged context, the children (slot content) and the parent tag name - plus one thing the key
...
export default class RenderCache {
  ...
  // outside a pass, and for a cid that has already rendered once in this pass.
  //
  ...
  static enter(cidKey, bindingCounts) {
    if (!$.#isPassActive) {
      return null;
    }
